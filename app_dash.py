...
@app.callback(
    ...
    Output("selected_station_idx", "data"),
...
def render_station_list(stations, selected_idx):
    ...
    n = len(stations)
    if n == 0:
        return html.Div("No stations yet. Click on the map to add stations (or use the marker draw tool)."), None, 1
    ...
    return html.Div(items), int(selected_idx), min(n + 1, int(selected_idx) + 1)
